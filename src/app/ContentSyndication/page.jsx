...
"use client";
import { motion } from "framer-motion";
import { ArrowUpRight, Plus, Upload, Target, Users, Database, X, Globe, Zap, Shield, Star, Check, Mail, Phone, MessageSquare, User, AlertCircle } from "lucide-react";
import { useState } from "react";
import Head from 'next/head';
import Link from 'next/link';
import Image from 'next/image';
...
function B2BcontentSyndication() {
  ...
  const validateForm = () => {
    ...
    if (!formData.description) {
      newErrors.description = 'Please select a service';
    }
      ...
      {showModal && (
        ...
        >
          <motion.div 
            ...
            exit={{ opacity: 0, scale: 0.8, y: 50 }}
            transition={{ type: "spring", damping: 20, stiffness: 300 }}
            className="bg-white rounded-3xl shadow-2xl w-full max-w-6xl max-h-[98vh] overflow-hidden relative"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Close Button */}
            <motion.button 
              ...
              whileHover={{ scale: 1.1, rotate: 90 }}
              whileTap={{ scale: 0.9 }}
              className="absolute top-4 right-4 z-30 bg-gray-100/90 hover:bg-gray-200/90 backdrop-blur-sm p-3 rounded-full transition-all duration-200 shadow-lg"
            >
              <X size={20} className="text-gray-600" />
            </motion.button>
            ...
            <div className="h-full max-h-[98vh] overflow-y-auto">
              ...
              <div className="block lg:hidden">
                ...
                <div className="bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] p-8 text-white relative overflow-hidden">
                  <div className="relative z-10">
                    <div className="flex items-center mb-6">
                      <div className="bg-gradient-to-r from-[#FFD700] to-[#FFA500] p-3 rounded-xl mr-4 shadow-xl">
                        <Database className="w-8 h-8 text-black" />
                      </div>
                      <div>
                        <h3 className="text-2xl font-bold">ProspectBase</h3>
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                      <p className="text-blue-200 text-sm mb-4 text-center font-semibold">Global Database Coverage</p>
                      <div className="grid grid-cols-3 gap-4">
                        <div className="text-center">
                          <div className="text-2xl font-bold text-[#FFD700] mb-2">185M+</div>
                          <div className="text-xs text-blue-200">B2B Contacts</div>
                        </div>
                        <div className="text-center">
                          <div className="text-2xl font-bold text-[#4ECDC4] mb-2">142</div>
                          <div className="text-xs text-blue-200">Countries</div>
                        </div>
                        <div className="text-center">
                          <div className="text-2xl font-bold text-[#FF6B6B] mb-2">25M+</div>
                          <div className="text-xs text-blue-200">Companies</div>
                        </div>
                      </div>
                    </div>
                  ...
                  {/* Background Elements */}
                  <div className="absolute -top-10 -left-10 w-32 h-32 bg-gradient-to-br from-[#FFD700]/20 to-[#FFA500]/20 rounded-full blur-3xl"></div>
                  <div className="absolute -bottom-10 -right-10 w-24 h-24 bg-gradient-to-br from-[#4ECDC4]/20 to-[#44A08D]/20 rounded-full blur-2xl"></div>
                </div>
                
                {/* Mobile Form */}
                <div className="p-8">
                  <div className="mb-8">
                    <h3 className="text-2xl font-bold text-gray-800 mb-3">Request Audience Count</h3>
                    <p className="text-gray-600">Fill out the form below and we'll provide you with detailed audience insights within 24 hours.</p>
                  </div>
                  ...
                  {submitStatus === 'success' && (
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div>
                          <h4 className="text-green-800 font-semibold">Success!</h4>
                          <p className="text-green-700 text-sm">Your request has been submitted successfully. We'll get back to you within 24 hours!</p>
                        </div>
                      </div>
                    </motion.div>
                  )}
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="text-red-700 text-sm">There was an error submitting your request. Please check your information and try again.</p>
                        </div>
                      </div>
                    </motion.div>
                  )}
                  ...
                  {submitStatus === 'validation_error' && (
                    <motion.div 
                      initial={{ opacity: 0, y: -20 }}
                      animate={{ opacity: 1, y: 0 }}
                      className="mb-6 p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded-r-xl"
                    >
                      <div className="flex items-center">
                        <AlertCircle className="w-5 h-5 text-yellow-400 mr-3" />
                        <div>
                          <h4 className="text-yellow-800 font-semibold">Please Check Your Information</h4>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          placeholder="Enter your first name"
                          className={`w-full px-4 py-3 bg-white border-2 ${errors.firstName ? 'border-red-300 focus:border-red-500' : 'border-gray-200 focus:border-blue-500'} rounded-xl focus:ring-2 focus:ring-blue-500 transition-all duration-300 text-gray-900 placeholder-gray-500`}
                          required
                        />
                        {errors.firstName && (
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          placeholder="Enter your last name"
                          className={`w-full px-4 py-3 bg-white border-2 ${errors.lastName ? 'border-red-300 focus:border-red-500' : 'border-gray-200 focus:border-blue-500'} rounded-xl focus:ring-2 focus:ring-blue-500 transition-all duration-300 text-gray-900 placeholder-gray-500`}
                          required
                        />
                        {errors.lastName && (
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          onChange={handleInputChange}
                          placeholder="Enter your email"
                          className={`w-full px-4 py-3 bg-white border-2 ${errors.email ? 'border-red-300 focus:border-red-500' : 'border-gray-200 focus:border-blue-500'} rounded-xl focus:ring-2 focus:ring-blue-500 transition-all duration-300 text-gray-900 placeholder-gray-500`}
                          required
                        />
                        {errors.email && (
