              ...
              >
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                    {[
                      { icon: Target, text: "Territory Management" },
                      { icon: TrendingUp, text: "Forecasting" },
                      { icon: Zap, text: "Sales Technology" },
                      { icon: Shield, text: "Value-based Selling" },
                    ].map((feature, index) => (
                      <motion.div
                        key={index}
