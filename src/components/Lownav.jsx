        ...
        >
            <div className="flex items-center gap-x-1">
                <Link href="/" passHref legacyBehavior>
                    <a className="focus:outline-none focus:ring-2 focus:ring-[#386861] rounded">
                        <Image
                            src={Logo1}
            ...
            >
                <li className="relative group">
                    <Link href="/" passHref legacyBehavior>
                        <a className={`hover:text-gray-700 border-0 font-bold ${responsiveStyles.textSize} transition-colors focus:outline-none focus:ring-2 focus:ring-[#386861] focus:rounded`}>
                            Home
                        </a>
                    </Link>
                </li>
                <li className="relative group">
                    <Link href="/About" passHref legacyBehavior>
                        <a className={`hover:text-gray-700 font-bold ${responsiveStyles.textSize} focus:outline-none focus:ring-2 focus:ring-[#386861] focus:rounded`}>
                            About Us
                        </a>
                    </Link>
                </li>
                        ...
                        {solutionsItems.map((item, i) => (
                            <li key={i} className="px-4 py-3 hover:bg-[#386861] hover:text-white text-lg border-b border-[#e6d9a1] last:border-b-0">
                                <Link href={item.link} passHref legacyBehavior>
                                    <a className="block w-full h-full focus:outline-none focus:ring-2 focus:ring-white rounded">
                                        {item.name}
                                    </a>
                                </Link>
                            </li>
                            ...
                            <div className="grid grid-cols-3 gap-4 p-4 w-max">
                                {solutionsDesktopItems.map((item, index) => (
                                    <div key={index} className="relative w-56 h-56 overflow-hidden rounded-lg group/item">
                                        ...
                                        <Link href={item.link} passHref legacyBehavior>
                                            <a className="absolute inset-0 z-20 focus:outline-none focus:ring-2 focus:ring-white rounded"></a>
                                        </Link>
                                    </div>
                                ))}
                            </div>
